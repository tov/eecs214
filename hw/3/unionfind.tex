...
\newcommand{\sourcefilelong}{%
  \url{http://users.eecs.northwestern.edu/~jesse/course/eecs214-fa15/hw/3/unionfind.rkt}%
}
...
number of objects identified by natural numbers from $0$.
...
The provided file \sourcefile, containing 1) a definition of your
^UnionFind^ data type, and 2) complete, working definitions of the five
functions specified above. Thorough testing is strongly recommended but
will not be graded.
